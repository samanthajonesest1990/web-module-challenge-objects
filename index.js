...
console.log('tast 1 a', createMenuItem('tacos', 8, 'Lunch'));
...
console.log('task 1 b:', createMenuItem('chocolate milk', 6, 'Drinks'));
...
reviews.push({name: 'Sam', rating: 4, feedback: 'this place is good!'});
